...
ExecStart=$PROXY_BIN --token $(load_token_from_file) $protocol --port $port $ssh_only --buffer-size 16384 --workers 2500 $cert_path --response $response --log-file $proxy_log_file
StandardOutput=null
StandardOutput=null
Restart=always
TasksMax=5000
